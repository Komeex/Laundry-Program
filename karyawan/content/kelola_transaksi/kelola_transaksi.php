...
if(isset($_POST['btncari'])){
    $keyword = $_POST['cari'];
    $q = "SELECT * FROM tbl_transaksi INNER JOIN tbl_paket AS paket ON tbl_transaksi.id_paket = paket.id_paket WHERE id_transaksi LIKE '%$keyword%' or nama_pelanggan LIKE '%$keyword%' or no_hp LIKE '%$keyword%'
